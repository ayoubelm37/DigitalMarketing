...
export default function Navbar() {
  ...
  return (
    <nav 
      className={`w-screen fixed top-0 left-0 z-50 py-2 transition-colors duration-500 ${scrolled ? 'bg-[#0a1525]/95' : 'bg-transparent'}`}
      dir={direction}
    >
      <div className="max-w-7xl mx-auto flex items-center justify-between px-8 py-3">
        ...
        <div className="hidden md:flex items-center justify-center space-x-4">
          <Link href={`/${currentLocale}/`} className="text-white hover:bg-[#0a1525] hover:text-rose-500 transition-colors w-20 h-10 flex items-center justify-center">
            {t.navigation.home}
          </Link>
          <Link href={`/${currentLocale}/about`} className="text-white hover:bg-[#0a1525] hover:text-rose-500 transition-colors w-20 h-10 flex items-center justify-center">
            {t.navigation.about}
          </Link>
          ...
          <Link href={`/${currentLocale}/contact`} className="text-white hover:bg-[#0a1525] hover:text-rose-500 transition-colors w-20 h-10 flex items-center justify-center">
